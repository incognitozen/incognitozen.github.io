...
title: mxGraph
draft: false 
website: https://github.com/jgraph/mxgraph
classification: ['']
platform: ['Web']
keywords: ['Diagram-JS', 'Draw2D', 'FabricJS', 'GoJS', 'JavaScript InfoVis Toolkit', 'JointJS', 'JsDiagram', 'Paper.js', 'jsPlumb']
---
...
<strong>Update 5/09/2021</strong>

Development on mxGraph has now stopped, this repo is effectively end of life.

Known forks:

<a href="https://github.com/jsGraph/mxgraph">https://github.com/jsGraph/mxgraph</a>

<a href="https://github.com/process-analytics/mxgraph">https://github.com/process-analytics/mxgraph</a>